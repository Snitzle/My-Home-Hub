                ...
                <div class="">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                        <div class="p-6 text-gray-900">
                            ...
                            <form method="POST"
                                  action="{{ route('property.job.comment.update', [ $property->id, $job->id, $comment->id ]) }}"
                                ...
                                <label for="title">
                                    ...
                                    <small>Title</small>
                                    <input type="text" class="input-control" name="title" value="{{ $comment->title }}">
                                ...
                                <label for="description">
                                    ...
                                    <small>Content</small>
                                    <textarea type="text" class="input-control" name="content" value="">{{ $comment->content }}</textarea>
