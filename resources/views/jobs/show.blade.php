    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="">
                ...
                <a href="{{ route('property.job.edit', [$property->id, $job->id] ) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4">
                    Update
                </a>

                <a href="{{ route('property.job.destroy', [$property->id, $job->id] ) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded mr-4">
                    Complete Job
                </a>

                <a href="{{ route('property.job.destroy', [$property->id, $job->id] ) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                    Delete Job
                </a>
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-4">
                        <div class="p-6 text-gray-900">
                            ...
                            <div class="">
                                <h3>Worker</h3>
                                <p class="">
                                    Get worker and provide link to them in system
                                </p>
                            </div>
